...
from common.exceptions.errors import NotFoundError
from infrastructure.postgres.base import UUIDBase
from infrastructure.persistence.repositories.base_data_mapper import BaseMapper

__all__ = ["BaseRepository", "NotFoundError"]


class BaseRepository[T: UUIDBase, R: BaseModel](ABC):
    model: type[T]
    schema: type[R]
